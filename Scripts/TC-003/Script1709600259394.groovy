...
WebUI.setText(findTestObject('LoginPage/input_email_email'), 'tokoku@mailsec.com', FailureHandling.OPTIONAL)
...
WebUI.verifyElementPresent(findTestObject('LoginPage/dd_hai'), 0, FailureHandling.STOP_ON_FAILURE)
